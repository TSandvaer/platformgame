...
`MONGODB_URI` (Atlas connection string), `DB_NAME`, `NODE_ENV`, `PORT`, and the Firebase Admin trio `FIREBASE_PROJECT_ID` / `FIREBASE_CLIENT_EMAIL` / `FIREBASE_PRIVATE_KEY`. See `MONGODB_SETUP.md` for Atlas setup.
